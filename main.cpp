...
void taxevasion(){
    string evadingtaxes;
    cout << "Do you want to evade taxes? [Y/N] (Evading taxes doubles all profits, however there is a 50 50 chance you will get caught" << endl;
    cin >> evadingtaxes;
    if(evadingtaxes=="y" || evadingtaxes=="Y"){
        evadingtax=true;
    }
    else{
        evadingtax=false;
